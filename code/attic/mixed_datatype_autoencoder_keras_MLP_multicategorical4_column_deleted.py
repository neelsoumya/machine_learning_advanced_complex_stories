...
#
# Usage:
#   python mixed_datatype_autoencoder_keras_MLP_multicategorical4_column_deleted.py df_med_suicide_features_lengthened_final_ml_f20_FULL_column_deleted.csv  drug_suidata_autoencoder_f20_MLP_FULL_column_deleted  0.2
#  
# Adapted from:
