...
#
# Usage:
#   python3 mixed_datatype_autoencoder_keras_MLP_multicategorical4.py df_med_suicide_features_lengthened_final_ml_f20_FULL.csv  drug_suidata_autoencoder_f20_MLP_FULL  0.2
...
if __name__ == '__main__':
    ...
    tpot = TPOTClassifier(generations=100, population_size=500, verbosity=2, n_jobs=2) #scoring='f1', n_jobs=2) scoring='roc_auc'	
