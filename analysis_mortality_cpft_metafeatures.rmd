                                  ...
                                  p_minkowski)
{
      ...
      #
      # options for str_method_distance_metric are:
      #   "euclidean", "maximum", "manhattan", "canberra", "binary" or "minkowski"
      #
      # options for str_method_clustering are:
...
# TODO: evaluate NOTE: this is all patients with all diagnosis
...
str_exprn_roc_calculation = " Death_Flag ~ age_now_scaled " # just a simple formula to be passed to ROC functions to calculate AUC, AUPR etc.
...
# publication ready plots for logistic regression schizophrenia main effects
# rename columns by introducing new columns
df_f20_temp$specific_personality_disorder <- df_f20_temp$emotional_personality_disorder
df_f20_temp$age_scaled <- df_f20_temp$age_now_scaled
df_f20_temp$suicide_attempt <- df_f20_temp$suicide_any
df_f20_temp$antidepressant <- df_f20_temp$anti_depressant
df_f20_temp$antihypertensive <- df_f20_temp$anti_hypertensive

str_query = " mylogit_glmer_all_f20 <- glmer(formula = Death_Flag ~ age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "
...
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + suicide_attempt*cardiovascular +  self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)

# advanced paper
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + diuretic*cardiovascular +  self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)

# advanced paper
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ cardiovascular*diuretic + delirium*cardiovascular + diuretic*delirium + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)

# advanced paper
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ cardiovascular*diuretic + delirium*cardiovascular + diuretic*delirium + cardiovascular*diuretic*delirium +  age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)

# advanced paper
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~  delirium*cardiovascular + diuretic*delirium +  age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "
...
# advanced paper
# publication ready plot
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ cardiovascular*diuretic + dementia_alzheimer*cardiovascular + diuretic*dementia_alzheimer + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)
# hopw many ptients have co-occurrence of diuretic, dementia and cardiovascular
sqldf::sqldf(' select *
             from df_f20_temp
             where cardiovascular = 1 and diuretic = 1 and dementia_alzheimer = 1')

sqldf::sqldf(' select *
             from df_f20_temp
             where cardiovascular = 1  and dementia_alzheimer = 1')

sqldf::sqldf(' select *
             from df_f20_temp
             where diuretic = 1  and dementia_alzheimer = 1')

sqldf::sqldf(' select *
             from df_f20_temp
             where dementia_alzheimer = 1')
# 25 patients


# dementia*abuse_alchol_drugs
# publication ready plot
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~  abuse_alcohol_drugs*dementia_alzheimer + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "
...
# dementia*delirium
# publication ready plot
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~  delirium*dementia_alzheimer + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "
...
# publication ready plot
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~  diuretic*cardiovascular + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "
...
# age interactions
df_f20_temp$age_scaled <- df_f20_temp$age_now_scaled
str_query_interact_age = " mylogit_glmer_all_f20_interact_age <- glmer(formula = Death_Flag ~ age_scaled  + dementia_alzheimer + delirium + dementia_alzheimer + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + emotional_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + anti_depressant + suicide_any + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + anti_hypertensive + aspirin + age_scaled*dementia_alzheimer + age_scaled*delirium + age_scaled*dementia_alzheimer + age_scaled*mild_cognitive_disorder + age_scaled*abuse_alcohol_drugs + age_scaled*major_depression + age_scaled*emotional_personality_disorder + age_scaled*respiratory + age_scaled*cardiovascular + age_scaled*diabetes + age_scaled*self_harm + age_scaled*lack_family_support + age_scaled*personal_risk_factors + age_scaled*SGA + age_scaled*anti_depressant + age_scaled*suicide_any + age_scaled*dementia_drug + age_scaled*antimanic_drug + age_scaled*thyroid + age_scaled*FGA + age_scaled*diuretic + age_scaled*anti_hypertensive + age_scaled*aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "


eval(parse(text=str_query_interact_age)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact_age)
cris$fixed_effects_from_lmer(mylogit_glmer_all_f20_interact_age)

# take away new column names
df_f20_temp$specific_personality_disorder <- NULL
df_f20_temp$age_scaled <- NULL
df_f20_temp$suicide_attempt <- NULL
df_f20_temp$antidepressant <- NULL
df_f20_temp$antihypertensive <- NULL
...
if (i_do_not_run == FALSE)
{
          ...
          colnames(mat_original_data)[22] <- 'Death'
...
df_visualization_class_contrast_noextra <- cbind(df_visualization_class_contrast_noextra, df_visualization_class_contrast[45:49], df_visualization_class_contrast[43])#, df_visualization_class_contrast[17])

# replace NA with 0
idx_temp_na_replace <- which(is.na(df_visualization_class_contrast_noextra), arr.ind = TRUE)
df_visualization_class_contrast_noextra[idx_temp_na_replace] <- 0

# rename columns
df_visualization_class_contrast_noextra$antidepressant <- df_visualization_class_contrast_noextra$anti_depressant
df_visualization_class_contrast_noextra$anti_depressant <- NULL

df_visualization_class_contrast_noextra$antihypertensive <- df_visualization_class_contrast_noextra$anti_hypertensive
df_visualization_class_contrast_noextra$anti_hypertensive <- NULL

df_visualization_class_contrast_noextra$specific_personality_disorder <- df_visualization_class_contrast_noextra$emotional_personality_disorder
df_visualization_class_contrast_noextra$emotional_personality_disorder <- NULL
...
#pheatmap::pheatmap(mat = log10(df_visualization_class_contrast_noextra + 1e-6),
#                   scale = "none",
#                   show_colnames = TRUE,
#                   show_rownames = FALSE,
#                   cluster_rows = TRUE,
...
# TODO: scale and plot
# TODO: reorder lefa nodes using cba
# s_all_gene_matched_withprobeid_osm_agg <- t(scale(t(all_gene_matched_withprobeid_osm_agg)))
# high <- quantile(abs(s_all_gene_matched_withprobeid_osm_agg), 0.95, na.rm = TRUE)
# ncolors <- 500
...
#   fn_reorder_dendrogram(m_matrix=(s_all_gene_matched_withprobeid_osm_agg),
...
#   fn_reorder_dendrogram(m_matrix=(t(all_gene_matched_withprobeid_osm_agg)),
#                         str_method_distance_metric = "manhattan",
#                         str_method_clustering = "centroid",
#                         p_minkowski = 1.2) 
# 
# # options for str_method_distance_metric are:
# #   "euclidean", "maximum", "manhattan", "canberra", "binary" or "minkowski"
...
# #   "mcquitty" (= WPGMA), "median" (= WPGMC) or "centroid" (= UPGMC).
# 
# pheatmap(s_all_gene_matched_withprobeid_osm_agg,
...
#          #annotation_row = df_annotation_row_pheatmap,
#          show_colnames = FALSE,
#          show_rownames = TRUE,
...
#          fontsize = 10, cellwidth = 3, cellheight = 8, 
#          filename = "limma_osm_paper_microarray_logistic_regression_v5_JANSSEN_heatmap.pdf")#,
...
df_visualization_class_contrast_noextra_rowscaled = scale(t(df_visualization_class_contrast_noextra))
# TODO: 
#pheatmap::pheatmap(mat = df_visualization_class_contrast_noextra_rowscaled,
#                   scale = "none",
#                   show_colnames = TRUE,
#                   show_rownames = FALSE,
#                   cluster_rows = TRUE,
...
sqldf::sqldf('select * from df_f20_temp where dementia_alzheimer = 1 and diuretic = 1 and cardiovascular  = 1')
# no patinets

sqldf::sqldf('select * from df_f20_temp where dementia_alzheimer = 1 and diuretic  = 1')
# 3 patients

sqldf::sqldf('select * from df_f20_temp where dementia_alzheimer = 1 and cardiovascular  = 1')
# 2 patients

sqldf::sqldf('select * from df_f20_temp where abuse_alcohol_drugs  = 1 and cardiovascular = 1 and dementia_drug = 1')
# 0


# VERY IMPORTANT
summary(df_visualization_class_contrast_noextra_ML_deep_learning_model_3comb)
# looking at 673rd column which has min of -0.29 one of the lowest
#     looking at list_tuples_3_advanced_MOD.csv
#     671st tuple is 9,12,17
#     looking at df_med_suicide_features_lengthened_final_ml_f20_FULL_column_deleted_MOD.csv
#     this is 
# tuples are in list_tuples_3_advanced.csv
# column names are in df_med_suicide_features_lengthened_final_ml_f20_FULL_column_deleted.csv
# 1 age_now_scaled,
...
# sqldf::sqldf('select * from df_f20_temp where self_harm  = 1 and SGA = 1 and antimanic_drug = 1')

sqldf::sqldf('select * from df_f20_temp where self_harm  = 1 and SGA = 1 and FGA = 1')
# 10 patients and only 1 died
# hence deep learning may infer that these are associated with protection
# we found 10 cases that are similar to each other using case based reasoning

# another from summary is column 661 which is 9,11,12
sqldf::sqldf('select * from df_f20_temp where self_harm  = 1 and SGA = 1 and personal_risk_factors = 1')
# 9 patiuents 2 died

# sqldf::sqldf('select * from df_f20_temp where suicide_any  = 1 and SGA = 1 and FGA = 1')
...
# advanced paper
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ self_harm*SGA + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes +  self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)

# advanced paper publication ready plot
str_query_interact = " mylogit_glmer_all_f20_interact <- glmer(formula = Death_Flag ~ self_harm*FGA + self_harm*SGA + age_scaled  + dementia_alzheimer + delirium + mild_cognitive_disorder + abuse_alcohol_drugs + major_depression + specific_personality_disorder + respiratory + cardiovascular + diabetes +  self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin + (1|rid), data = df_f20_temp, family = 'binomial', control = glmerControl(optimizer = 'bobyqa'), nAGQ = 10 ) "

eval(parse(text=str_query_interact)) 
cris$visualize_fixed_effects_from_lmer(mylogit_glmer_all_f20_interact)

sqldf::sqldf('select * from df_f20_temp where SGA = 0 and FGA = 0 and self_harm = 0')
# 152 rows
sqldf::sqldf('select * from df_f20_temp where SGA = 1 and FGA = 1 and self_harm = 1')
# 10 rows
...
#ublication ready plots
df_time_to_event_f20$specific_personality_disorder <- df_time_to_event_f20$emotional_personality_disorder
df_time_to_event_f20$age_scaled <- df_time_to_event_f20$age_now_scaled
df_time_to_event_f20$suicide_attempt <- df_time_to_event_f20$suicide_any
df_time_to_event_f20$antidepressant <- df_time_to_event_f20$anti_depressant
df_time_to_event_f20$antihypertensive <- df_time_to_event_f20$anti_hypertensive
str_query = " cxph_f20_lack_family <- survival::coxph(formula = surv_object_f20 ~ age_scaled  + dementia_alzheimer + delirium + abuse_alcohol_drugs + specific_personality_disorder + respiratory + cardiovascular + diabetes + self_harm + lack_family_support + personal_risk_factors + SGA + antidepressant + suicide_attempt + dementia_drug + antimanic_drug + thyroid + FGA + diuretic + antihypertensive + aspirin  , data = df_time_to_event_f20 ) "
...
# diagnostiscs
survminer::ggcoxdiagnostics(fit = cxph_f20_lack_family, type = 'schoenfeld')
survminer::ggcoxdiagnostics(fit = cxph_f20_lack_family)


# remove specific
df_time_to_event_f20$specific_personality_disorder <- NULL
df_time_to_event_f20$age_scaled <- NULL
df_time_to_event_f20$suicide_attempt <- NULL
df_time_to_event_f20$antidepressant <- NULL
df_time_to_event_f20$antihypertensive <- NULL
