...
if __name__ == '__main__':
    ...
    #np.savetxt('df_class_contrastive_ml_from_python_3tuple.csv', df_class_contrastive_ml, delimiter='\t')
    ...
    tuple_temp = [x for x in combinations(list_temp, 3) ]

    with open("list_tuples_3_advanced.csv", 'w', newline='\n') as outfile:
        wr = csv.writer(outfile)#, quoting=csv.QUOTE_ALL)
        for (x, y, z) in tuple_temp:
            print(x,y,z)
            wr.writerow([x,y, z])
    ...
    for i_temp_patient_index_1 in range(0, i_num_patients_testset - 1):
        ...
        for (i_temp_col_mutate_1, i_temp_col_mutate_2, i_temp_col_mutate_3) in tuple_temp:
            # NOTE: do this for the original x_test that is x_test_orig
            #  each feature is one hot encoded adn each feature is binary so python will convert to 10 or 01
            x_test_orig[i_temp_patient_index_1, i_temp_col_mutate_1] = 1  # mutate this patient to a 1
            x_test_orig[i_temp_patient_index_1, i_temp_col_mutate_1 + 1] = 0  # mutate this patient to a 1
            ...
            x_test_orig[i_temp_patient_index_1, i_temp_col_mutate_3] = 1  # mutate this patient to a 1
            x_test_orig[i_temp_patient_index_1, i_temp_col_mutate_3 + 1] = 0  # mutate this patient to a 1
            ...
            x_test_orig[i_temp_patient_index_1, i_temp_col_mutate_3] = 0  # mutate this patient to a 1
            x_test_orig[i_temp_patient_index_1, i_temp_col_mutate_3 + 1] = 1  # mutate this patient to a 1
    ...
    # save data frame of class-contrastive results to hard disk
    # this will be read from R
    np.savetxt('df_class_contrastive_ml_3comb_from_python_advanced.csv', df_class_contrastive_ml_2comb, delimiter = '\t')
    ...
    # TODO: pick only demential/delirium, cardiovascular and diuretics and mutate copy some code from above
